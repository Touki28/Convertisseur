...
public class Convertisseur
{
	...
	{
		return new String[] { "Monnaie", "Distance", "Temperature", "Vitesse" };
	}
	...
	public static double calculer( String type, double valeur )
	{
		double resultat = 0.0;
	...
	public static void ajouterLog( String type, String resultat )
	{
		PrintWriter pw;
